...
func (v Value) Kind() ValueKind {
	...
	case groupptr:
		return ValueKindGroup
	case LogValuer:
		return ValueKindLogValuer
...
func Uint64Value(v uint64) Value {
	return Value{num: v, any: ValueKindUint64}
}
...
func BoolValue(v bool) Value {
	...
	return Value{num: u, any: ValueKindBool}
}
...
func DurationValue(v time.Duration) Value {
	return Value{num: uint64(v.Nanoseconds()), any: ValueKindDuration}
}
...
func (v Value) Int64() int64 {
	if g, w := v.Kind(), ValueKindInt64; g != w {
...
func (v Value) Uint64() uint64 {
	if g, w := v.Kind(), ValueKindUint64; g != w {
		panic(fmt.Sprintf("Value kind is %s, not %s", g, w))
	}
	return v.num
}
...
func (v Value) Bool() bool {
	if g, w := v.Kind(), ValueKindBool; g != w {
		panic(fmt.Sprintf("Value kind is %s, not %s", g, w))
	}
	return v.bool()
}
...
func (v Value) Duration() time.Duration {
	if g, w := v.Kind(), ValueKindDuration; g != w {
		panic(fmt.Sprintf("Value kind is %s, not %s", g, w))
	}
...
func (v Value) Float64() float64 {
	if g, w := v.Kind(), ValueKindFloat64; g != w {
		panic(fmt.Sprintf("Value kind is %s, not %s", g, w))
	}
...
func (v Value) Time() time.Time {
	if g, w := v.Kind(), ValueKindTime; g != w {
		panic(fmt.Sprintf("Value kind is %s, not %s", g, w))
	}
	return v.time()
}
...
func (v Value) Equal(w Value) bool {
	...
	switch k1 {
	case ValueKindInt64, ValueKindUint64, ValueKindBool, ValueKindDuration:
		return v.num == w.num
	case ValueKindString:
		return v.str() == w.str()
	case ValueKindFloat64:
