...
type TimersClient interface {
	...
	DeleteTimer(ctx context.Context, in *DeleteTimerArgs, opts ...grpc.CallOption) (*empty.Empty, error)
	DeleteTimers(ctx context.Context, in *DeleteTimersArgs, opts ...grpc.CallOption) (*empty.Empty, error)
}
...
func (c *timersClient) DeleteTimer(ctx context.Context, in *DeleteTimerArgs, opts ...grpc.CallOption) (*empty.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(empty.Empty)
...
func (c *timersClient) DeleteTimers(ctx context.Context, in *DeleteTimersArgs, opts ...grpc.CallOption) (*empty.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(empty.Empty)
...
type TimersServer interface {
	...
	DeleteTimer(context.Context, *DeleteTimerArgs) (*empty.Empty, error)
	DeleteTimers(context.Context, *DeleteTimersArgs) (*empty.Empty, error)
...
func (UnimplementedTimersServer) DeleteTimer(context.Context, *DeleteTimerArgs) (*empty.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method DeleteTimer not implemented")
}
func (UnimplementedTimersServer) DeleteTimers(context.Context, *DeleteTimersArgs) (*empty.Empty, error) {
